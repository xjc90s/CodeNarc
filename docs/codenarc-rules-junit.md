...
NOTE: This rule has been "moved" to the "spock" ruleset: [SpockIgnoreRestUsed](./codenarc-rules-spock.html#spockignorerestused-rule)
and has been disabled within the "junit" ruleset by default. It will be removed from the "junit" ruleset in a future CodeNarc release.
See [CodeNarc - Configuring Rules](./codenarc-configuring-rules.html).


## SpockMissingAssert Rule

NOTE: This rule has been "moved" to the "spock" ruleset: [SpockMissingAssert](./codenarc-rules-spock.html#spockmissingassert-rule)
and has been disabled within the "junit" ruleset by default. It will be removed from the "junit" ruleset in a future CodeNarc release.
See [CodeNarc - Configuring Rules](./codenarc-configuring-rules.html).
...
NOTE: This rule has been "moved" to the "spock" ruleset: [SpockUseVerifyEach](./codenarc-rules-spock.html#spockuseverifyeach-rule)
and has been disabled within the "junit" ruleset by default. It will be removed from the "junit" ruleset in a future CodeNarc release.
See [CodeNarc - Configuring Rules](./codenarc-configuring-rules.html).
